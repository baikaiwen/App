 ...
 * Numeric wheel view.
 * 
 * @author zhangyi 2014年7月16日 15:21:144
 */
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFFFF4F4F;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF686868;
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (widthLabel > 0) {
			if (labelLayout == null || labelLayout.getWidth() > widthLabel) {
				labelLayout = new StaticLayout(label, valuePaint, widthLabel, Layout.Alignment.ALIGN_NORMAL, 1, ADDITIONAL_ITEM_HEIGHT,
						false);
			} else {
