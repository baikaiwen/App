...
public class DbYetBwnoQty {
  private static final String TAG = "DbYetBwnoQty";
  
  private DbProductInfoHelper helper;
  private SQLiteDatabase db;

  private static final String TABLE_NAME = "yetbwnoqty";

  private static DbYetBwnoQty dbYetBwnoQty;
  
  public static DbYetBwnoQty getInstance(Context mContext) {
    if (null == dbYetBwnoQty) {
      dbYetBwnoQty = new DbYetBwnoQty(mContext);
    }
    return dbYetBwnoQty;
  }
  
  public DbYetBwnoQty(Context mContext){
